...
public interface IGarenalDAO <L,K> {
     ...
     * @param mangParam là mảng giá trị cung cấp cho các tham số trong hql
     */
     ...
     * @param mangParam là mảng giá trị cung cấp cho các tham số trong hql ( có thể 1,2,3...)
     * Ví dụ
